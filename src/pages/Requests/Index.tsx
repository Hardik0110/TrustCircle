...
const Requests = () => {
    ...
    `flex items-center gap-2  border-b-2 text-sm sm:text-base ${
      activeTab === tabKey
    ...
    <div>
      ...
      <div className="w-full max-w-full lg:max-w-[1440px] h-auto lg:h-[241px] -mt-24 bg-gradient-to-b from-transparent to-white pb-8">
        <div className="flex flex-col">
          ...
          {/* Main Content Area */}
          <div className="flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 mt-4 lg:mt-0  lg:gap-8 relative">
             
              <div className="w-full lg:max-w-[998px] mt-4"> 
                <RequestTable type={activeTab === "Requests From Circle" ? "circle" : "created"} />
              </div>

              <div className="relative w-[306px] h-[174px] mt-4">
              <img 
